...
- Flutter 3.47.5 zip resuming via curl retry-loop (`C:\src\flutter_sdk.zip`, ~471MB/1.93GB — slow link, backgrounding); then extract + analyze/test/run. CI flutter job covers analyze/test per push meanwhile.
